...
def main():
    ...
    parser.add_argument('--opt', type=str, default='/home/jieh/Projects/DualRelu/Expand/DualRelu3/options/train/train_Enhance.yml',
            ...
            for val_data in val_loader:
                ...
                if current_step % opt['logger']['save_checkpoint_epoch'] == 0:
                    ...
                    save_img_path = os.path.join(img_dir,
                                                 '{:s}.png'.format(val_data['LQ_path'][0].split('/')[-1].split('.')[0]))
